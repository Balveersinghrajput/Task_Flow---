  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 sm:p-6 lg:p-8 relative bg-slate-950">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-10 left-10 sm:top-20 sm:left-20 w-64 h-64 sm:w-96 sm:h-96 bg-purple-500/10 rounded-full blur-3xl animate-pulse"></div>
        <div className="absolute bottom-10 right-10 sm:bottom-20 sm:right-20 w-72 h-72 sm:w-[500px] sm:h-[500px] bg-blue-500/10 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '1s' }}></div>
      </div>
      
      {/* Grid Pattern */}
      <div className="absolute inset-0 bg-[linear-gradient(rgba(168,85,247,0.03)_1px,transparent_1px),linear-gradient(90deg,rgba(168,85,247,0.03)_1px,transparent_1px)] bg-[size:40px_40px] sm:bg-[size:60px_60px] pointer-events-none"></div>
          ...
          <div className="relative bg-slate-900/90 backdrop-blur-2xl rounded-2xl border border-slate-800/50 shadow-2xl p-5 sm:p-6 md:p-8">
              ...
              <div>
                ...
                <div className="relative group">
                  ...
                  <input
                    ...
                    className="w-full pl-10 sm:pl-12 pr-3 sm:pr-4 py-3 sm:py-3.5 md:py-4 bg-slate-800/50 border border-slate-700/50 rounded-xl text-slate-100 text-sm sm:text-base placeholder:text-slate-500 focus:outline-none focus:border-purple-500/60 focus:ring-2 focus:ring-purple-500/20 focus:bg-slate-800/80 transition-all"
                    required
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="relative group">
                  ...
                  <input
                    ...
                    placeholder="••••••••"
                    className="w-full pl-10 sm:pl-12 pr-10 sm:pr-12 py-3 sm:py-3.5 md:py-4 bg-slate-800/50 border border-slate-700/50 rounded-xl text-slate-100 text-sm sm:text-base placeholder:text-slate-500 focus:outline-none focus:border-purple-500/60 focus:ring-2 focus:ring-purple-500/20 focus:bg-slate-800/80 transition-all"
                    required
                  />
                  <button
                    type="button"
            ...
            <div className="relative my-5 sm:my-6 md:my-8">
              ...
              <div className="relative flex justify-center">
                <span className="px-3 sm:px-4 bg-slate-900/90 text-slate-500 text-xs sm:text-sm font-medium">Or continue with</span>
              </div>
            </div>
            ...
            <button
              ...
              type="button"
              className="w-full flex items-center justify-center gap-2 sm:gap-3 py-3 sm:py-3.5 md:py-4 px-4 bg-slate-800/50 hover:bg-slate-700/50 border border-slate-700/50 hover:border-slate-600/50 rounded-xl text-slate-300 font-medium transition-all hover:scale-[1.01] active:scale-[0.99] group"
            >
            ...
            <div className="mt-5 sm:mt-6 text-center">
              <p className="text-slate-400 text-xs sm:text-sm">
                ...
                <Link href="/sign-up" className="text-purple-400 hover:text-purple-300 font-semibold transition-colors underline decoration-purple-400/30 underline-offset-4 hover:decoration-purple-400">
                  Sign up
                </Link>
              </p>
            </div>
