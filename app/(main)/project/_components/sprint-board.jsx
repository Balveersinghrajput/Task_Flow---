...
export default function SprintBoard({ sprints, projectId, orgId }) {
  ...
  if (issuesError) {
    return (
      <div className="relative overflow-hidden rounded-xl border-2 border-red-200 dark:border-red-900/50 bg-gradient-to-br from-red-50 to-white dark:from-red-950/20 dark:to-gray-900 p-4 sm:p-6 shadow-xl mx-2 sm:mx-0 mt-4">
        <div className="absolute top-0 right-0 w-24 h-24 sm:w-32 sm:h-32 bg-red-500/10 rounded-full blur-3xl pointer-events-none"></div>
  ...
  return (
    <div className="flex flex-col px-2 sm:px-4 lg:px-0">
      ...
      <div className="relative z-50 mb-4 sm:mb-6 pointer-events-auto">
        <SprintManager
      ...
      {issues && !issuesLoading && (
        <div className="relative z-40 mb-4 sm:mb-6 pointer-events-auto">
      ...
      {/* Error Message */}
      {updateIssuesError && (
        <div className="mb-4 p-3 sm:p-4 bg-red-100 dark:bg-red-900/20 border-2 border-red-300 dark:border-red-800 rounded-lg relative z-30">
      ...
      {(updateIssuesLoading || issuesLoading) && (
        <div className="mb-4 rounded-lg overflow-hidden shadow-lg relative z-30">
      ...
      <DragDropContext onDragEnd={onDragEnd}>
        <div className="relative">
          ...
          <div className="absolute -inset-1 bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 rounded-xl sm:rounded-2xl opacity-20 blur-2xl pointer-events-none"></div>
              ...
              <Droppable key={column.key} droppableId={column.key}>
                {(provided, snapshot) => (
                  <div
                    ...
                    className={`space-y-2 relative min-h-[200px] transition-colors duration-200 ${
                      snapshot.isDraggingOver ? "bg-blue-500/5 rounded-lg" : ""
                    }`}
                  >
                    {/* Column glow */}
                    <div className="absolute -inset-2 bg-gradient-to-b from-blue-500/5 via-purple-500/5 to-pink-500/5 rounded-lg blur-xl opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none"></div>
